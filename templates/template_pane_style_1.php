<?php if ( ! defined( 'ABSPATH' ) ) exit;   $vcode = $this->_config["vcode"];  ?>
 ...
 <div id="categoryaccordionpanel" style="width:<?php echo esc_attr( $this->_config["tp_widget_width"] ); ?>"  class="pane_style_1 <?php echo ( ( trim( $this->_config["display_title_price_over_image"] ) == "yes" ) ? "disp_title_over_img" : "" ); ?>">

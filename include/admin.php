...
if ( ! class_exists( 'categoryAccordionPanelWidget_Admin' ) ) { 
	class categoryAccordionPanelWidget_Admin extends categoryAccordionPanelLib {    
		...
		*/
		function form( $instance ) { 
			...
			require( $this->getCategoryAccordionPanelTemplate( 'admin_widget_settings.php' ) );
